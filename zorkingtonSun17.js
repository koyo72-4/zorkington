...
function takeItem(item) {
    ...
    console.log(itemTakeMessages[item]);
    currentInventory.inventory.push(properlyCapitalizedItem);
    currentInventory.lowerCaseInventory.push(item);
    console.log("\nYou have now added " + properlyCapitalizedItem + " to your inventory. Type 'inventory' at any time to see what items are in your inventory.");
};
...
function dropItem(item) {
    ...
    console.log("\nYou have now removed " + properlyCapitalizedItem + " from your inventory. Type 'inventory' at any time to see what items are in your inventory.");
}
...
function changeRoom(nextRoom) {
    ...
    if (validTransitions.includes(nextRoom)) {
        ...
        console.log("You cannot go to " + properlyCapitalizedNextRoom + " from " + properlyCapitalizedCurrentRoom + ".");
    }
};
    ...
    process.stdin.on('data', (chunk) => {
        ...
        if (action === "take" && object !== "sign" && object !== "granola") {
            if (currentInventory.lowerCaseInventory.includes(object)) {
                console.log("You already have " + properlyCapitalizedItem + " in your inventory.");
            } else if (!roomInventory[currentRoom].includes(object)) {
                console.log(properlyCapitalizedItem + " is not in this room.");
            } else {
                takeItem(object);
            }
            ...
            console.log("You are carrying:\n" + currentInventory.inventory.join("\n"));
        ...
        console.log('\nCurrent room: ' + properlyCapitalizedRoom + "\n");
    });
}
...
/*
At the lake: "You throw Champ some granola. It turns out he likes it. But only the organic stuff."
*/